...
def DecayFit(prodID = "Bs", decayID = "Bs", omegaCut = 0.49) :

   print "************************************"
   print "* Doing decay time fit: "+prodID+ " -> "+decayID
   print "*  for omega < "+str(omegaCut)
   print "************************************"
   ...
   frame.SetTitle("Decay Time ("+prodID+" -> "+decayID+"), TagOmega < " + omegaCut)
   ...
   print "************************************"
   print "* Result of " + prodID + " -> " + decayID
