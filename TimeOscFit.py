...
def TimeOscFit(offset = 0.0, amplitude = 40.0, period = 0.002, phase = 0.0,
      omegaCut = "0.49", Bs_Mass = (5330,5400), Ds_Mass = (1955, 1985), Bs_Lifetime = (0, 0.01) ) :
   ...
   t.Draw("lab0_TAU>>dec_Bs_Bs"        +binning, cuts_Bs_Bs        )
   t.Draw("lab0_TAU>>dec_antiBs_antiBs"+binning, cuts_antiBs_antiBs)
   ...
   oscHist_Bs.plotOn(frame)
   #oscHist_Full.plotOn(frame)
   model.plotOn(frame)
   frame.Draw()
   cOsc.Update()
